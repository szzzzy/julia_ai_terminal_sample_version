...
| 电量监测 | GPIO8/ADC1_CH7 读取板载3:1分压，按当前750mAh电池的整机带载表现将4.00V及以上显示为100%；正常／低电量／疑似充电时常驻显示百分比，不进入行为FSM |
...
| 电池采样 | `BAT_ADC=GPIO8/ADC1_CH7`，板载200K/100K分压；电压趋势只推测充电，不检测真实充电电流 |
| SDK | ESP-IDF 5.5.4 |
| 显示库 | 仓库内 LVGL 8.3.11 |
